...
export const LikeRecetas = async (req, res) =>{
    const {idReceta} = req.params
    const pool =await getConnection()
    const result3= await pool.request().input('idReceta', idReceta).query(queries.likeReceta)
    console.log(result3)
    res.send(result3)
}

export const DislikeRecetas = async (req, res) =>{
    const {idReceta} = req.params
    const pool =await getConnection()
    const result3= await pool.request().input('idReceta', idReceta).query(queries.dislikeReceta)
    console.log(result3)
    res.send(result3)
}
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
export const LikeRutina = async (req, res) =>{
    const {idRutina} = req.params
    const pool =await getConnection()
    const result3= await pool.request().input('idRutina', idRutina).query(queries.likeRutina)
    console.log(result3)
    res.send(result3)
}

export const dislikeRutina = async (req, res) =>{
    const {idRutina} = req.params
    const pool =await getConnection()
    const result3= await pool.request().input('idRutina', idRutina).query(queries.dislikesRutina)
    console.log(result3)
    res.send(result3)
}